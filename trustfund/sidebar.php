...
<aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-10">
    <div>
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="dashboard.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition <?= ($current_page == 'dashboard.php') ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
                <i class="fa-solid fa-house text-lg"></i><span>Dashboard</span>
            </a>
            
            <a href="my_groups.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition <?= ($current_page == 'my_groups.php' || $current_page == 'group_details.php') ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
                <i class="fa-solid fa-users text-lg"></i><span>My Groups</span>
            </a>
            
            <a href="payments.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition <?= ($current_page == 'payments.php') ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
                <i class="fa-solid fa-wallet text-lg"></i><span>Payments</span>
            </a>
            
            <a href="my_profile.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition <?= ($current_page == 'my_profile.php') ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
            ...
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <div class="pt-4 mt-4 border-t border-gray-100">
                    ...
                    <a href="admin.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition <?= ($current_page == 'admin.php') ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
    ...
    <div class="p-4 border-t border-gray-200 flex items-center justify-between bg-white">
        ...
        <a href="logout.php" class="p-2 border border-gray-200 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-xl transition" title="Sign Out">
